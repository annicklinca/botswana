                  ...
                  <div class="container my-4">  
                            <div class="row">
                              <div class="col-md-12 mb-4">
                                ...
                                <a href="http://www.facebook.com/login" className="text-black"><svg width="24" height="23" class="mx-8 my-2 inline-block" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="http://www.twitter.com/login" className="text-black"><svg width="24" height="23" class="mx-8 my-2 inline-block" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M21.7911 0.486328H1.8506C1.16738 0.486328 0.613281 1.04043 0.613281 1.72365V21.6642C0.613281 22.3474 1.16738 22.9015 1.8506 22.9015H12.5857V14.2215H9.66453V10.8386H12.5857V8.3433C12.5857 5.44815 14.3538 3.87192 16.9369 3.87192C18.1742 3.87192 19.2376 3.96427 19.5469 4.00551V7.03156L17.7555 7.03246C16.3505 7.03246 16.0789 7.69953 16.0789 8.67953V10.8395H19.4286L18.9919 14.2224H16.078V22.9015H21.7911C22.4744 22.9015 23.0285 22.3474 23.0285 21.6642V1.72365C23.0285 1.04043 22.4744 0.486328 21.7911 0.486328Z" fill="#485A96"></path></svg>
                                  ...
                                  <form class="pt-3 pb-5 pl-5 pr-5" onSubmit={handleSignup}>
                                    ...
                                    <div class="form-group">
                                      <label className="font-normal text-green-700 font-bold">USER NAME</label>
                                      <input type="text" className="form-control rounded-full p-4" value={username} onChange={event=>setUsername(event.target.value)} placeholder="Enter full name" required />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <label className="font-normal text-green-700 font-bold">PASSWORD</label>
                                    ...
                                    <div class="form-group">
                                      <label className="font-normal text-green-700 font-bold">RE-ENTER PASSWORD</label>
                                      <input type="password" className="form-control rounded-full p-4" value={repassword} onChange={event=>setRepassword(event.target.value)} placeholder="Enter password" required />
                                    </div>
