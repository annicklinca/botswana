...
function Boat() {
  ...
  const pathed='http://127.0.0.1:8000'
         ...
         useEffect( ()=>{
            // async await
           const response = axios.get('http://127.0.0.1:8000/Boat/') 
           .then(res=>{
             setData(res.data);
             console.log(res)
...
<h1 className="py-12 pt-48 text-4xl font-bold text-center text-white md:text-4xl">Explore Beautiful Boats in Botswana</h1>
...
<div  class="mx-3 mt-2">
<h5 className=" p-2 pt-4 font-bold">Best Boat</h5>
